        ...
        VStack {
            ...
            HStack {
                ...
                Button() {
                    ...
                    AsyncImage(url: URL(string: "https://drive.google.com/uc?id=1iDqYRdKLZerbZOHK2TCAxCr6aGHMH3w3")) { image in
                              image
                                  .resizable()
                                  .aspectRatio(contentMode: .fill)
            ...
            HStack {
                ...
                Button() {
                    ...
                    AsyncImage(url: URL(string: "https://drive.google.com/uc?id=1Y6oFeZKmBaQFjkMIBzgsZbGmubD5i1a-")) { image in
                              image
                                  .resizable()
                                  .aspectRatio(contentMode: .fill)
                          ...
                          .frame(width: 110, height: 110)
                          .background(RoundedRectangle(cornerRadius: 10)
                            .fill(didTap3 ? Color(.green) : Color(dataSource.selectedTheme.boxesColor))
                            .frame(width: 170, height: 120)
                          )
                          .padding()
                }
            ...
            NavigationLink(
                destination: Borrar7(quizTitle: "\(quizTitle)", quizWord: "\(quizWord)", quizProgress: (quizProgress + 0.1)
            ), label:{
                Text("Verificar")
                    .foregroundColor(Color(dataSource.selectedTheme.fontColor))
                    .font(.system(size: 24))
...
struct Borrar6_Previews: PreviewProvider {
    static var previews: some View {
        Borrar6(quizTitle: "No se encontró", quizWord: "No se encontró", quizProgress: 0.0)
