        ...
        VStack {
            ...
            HStack {
                ...
                Button() {
                    ...
                    AsyncImage(url: URL(string: "https://drive.google.com/uc?id=1GqV9fxAiwxlb7GSw7_GrTs8Vhk_oLXn6")) { image in
                              image
                                  .resizable()
            ...
            NavigationLink(
                destination: Borrar2(quizTitle: "\(quizTitle)", quizWord: "\(quizWord)", quizProgress: (quizProgress + 0.1)
            ), label:{
                Text("Verificar")
                    .foregroundColor(Color(dataSource.selectedTheme.fontColor))
                    .font(.system(size: 24))
...
struct Borrar1_Previews: PreviewProvider {
    static var previews: some View {
        Borrar1(quizTitle: "No se encontró", quizWord: "No se encontró", quizProgress: 0.0)
