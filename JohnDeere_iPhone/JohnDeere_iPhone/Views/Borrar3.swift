        ...
        VStack {
            ...
            HStack {
                ...
                Button() {
                    ...
                    AsyncImage(url: URL(string: "https://drive.google.com/uc?id=1rAyBlTg2l-p11PZTKprcTZKImmtjVk4r")) { image in
                              image
                                  .resizable()
                ...
                Button() {
                    ...
                    AsyncImage(url: URL(string: "https://drive.google.com/uc?id=1wegWeqAWG9kka2J5SxdTc_xp8xN8bF8o")) { image in
                              image
                                  .resizable()
                                  .aspectRatio(contentMode: .fill)
            ...
            NavigationLink(
                destination: Borrar4(quizTitle: "\(quizTitle)", quizWord: "\(quizWord)", quizProgress: (quizProgress + 0.1)
            ), label:{
                Text("Verificar")
                    .foregroundColor(Color(dataSource.selectedTheme.fontColor))
                    .font(.system(size: 24))
...
struct Borrar3_Previews: PreviewProvider {
    static var previews: some View {
        Borrar3(quizTitle: "No se encontró", quizWord: "No se encontró", quizProgress: 0.0)
