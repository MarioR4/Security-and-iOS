...
struct Borrar10: View {
    ...
    var content: some View {
        VStack {
            ...
            HStack {
                ...
                Button() {
                    ...
                    Text("W")
                        ...
                        .background(didTap1 ? Color(.green) : Color(dataSource.selectedTheme.boxesColor))
                        .cornerRadius(10)
            ...
            HStack {
                ...
                Button() {
                    ...
                    Text("G")
                        ...
                        .font(.system(size: 24))
                        .frame(width: 170, height: 50)
                        .background(didTap3 ? Color(.red) : Color(dataSource.selectedTheme.boxesColor))
                        .cornerRadius(10)
                        .padding([.bottom, .horizontal])
                }
            ...
            NavigationLink(
                destination: Borrar1(quizTitle: "\(quizTitle)", quizWord: "\(quizWord)", quizProgress: (quizProgress + 0.1)
            ), label:{
                Text("Verificar")
                    .foregroundColor(Color(dataSource.selectedTheme.fontColor))
                    .font(.system(size: 24))
...
struct Borrar10_Previews: PreviewProvider {
    static var previews: some View {
        Borrar10(quizTitle: "No se encontró", quizWord: "No se encontró", quizProgress: 0.0)
